  ...
  <div class="weeks">${createTagRepeat('span',6,{class:'week'})}</div>
    ...
    class DateRangePicker {
        constructor(element, options = {}) {
            ...
            this.datepickers = [setupDatepicker(this, changeDateListener, this.inputs[0], cleanOptions), setupDatepicker(this, changeDateListener, this.inputs[1], cleanOptions), ];
